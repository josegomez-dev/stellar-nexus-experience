...
import { BADGE_CONFIG, BADGE_CATEGORIES, BADGE_RARITY, getBadgeRarityConfig, getCategoryConfig } from '@/lib/badge-config';
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-brand-300 text-sm">
                  {earnedBadgeIds.length} of {allBadges.length} badges earned ({getCompletionPercentage()}%)
                </p>
              </div>
            </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="text-center mb-3">
                    ...
                    {/* Rarity Indicator */}
                    <div className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${rarityConfig.color} ${rarityConfig.bgColor}`}>
                      {rarityConfig.name}
                    </div>
                  </div>
                  ...
                  <div className="text-center">
                    <h3 className={`font-semibold mb-1 ${isEarned ? 'text-white' : 'text-white/60'}`}>
                      {badge.name}
                    </h3>
                    ...
                    {/* XP Reward */}
                    <div className={`text-xs font-medium ${isEarned ? 'text-brand-300' : 'text-white/40'}`}>
                      +{badge.xpReward} XP
                    </div>
        ...
        <div className="fixed inset-0 z-[10000] bg-black/95 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-gradient-to-br from-neutral-900 via-brand-900 to-neutral-900 border border-brand-400/30 rounded-2xl shadow-2xl max-w-md w-full p-6">
            <div className="text-center">
              ...
              {/* Rarity */}
              <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium mb-4 ${getBadgeRarityConfig(selectedBadge.rarity).color} ${getBadgeRarityConfig(selectedBadge.rarity).bgColor}`}>
