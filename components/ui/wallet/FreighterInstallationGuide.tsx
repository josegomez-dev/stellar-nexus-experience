...
export const FreighterInstallationGuide = ({
  isOpen,
  onClose,
}: FreighterInstallationGuideProps) => {
              ...
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-white/60 text-xs'>
                    Use Stellar Testnet Friendbot for free tokens
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className='bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-lg p-3 border border-purple-400/30'>
            <div className='flex items-center space-x-2'>
              ...
              <p className='text-purple-200 text-sm'>
                <strong>Pro Tip:</strong> Use the Stellar Testnet Friendbot to get free testnet
                tokens for trying out the demos!
              </p>
            </div>
          </div>
        </div>
