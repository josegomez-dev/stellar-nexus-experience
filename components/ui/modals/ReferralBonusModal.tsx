      ...
      <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl p-8 w-full max-w-md mx-4 border border-white/20 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-white/70 mb-6">
            You've been invited by <span className="text-green-400 font-semibold">{referrerName}</span>
          </p>
          ...
          <p className="text-white/60 text-sm mb-6">
            Your bonus has been automatically added to your account. 
            Start exploring the platform to earn more rewards!
          </p>
