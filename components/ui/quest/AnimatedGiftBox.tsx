        ...
        >
          ...
          <div className="relative w-full h-full flex flex-col items-center justify-center space-y-1">
            ...
            <div className="flex space-x-1 mb-2">
              ...
              <div className="text-lg animate-bounce" style={{ animationDelay: '0.3s' }}>💎</div>
            </div>
            ...
            <div className="flex space-x-1 mt-2">
              ...
              <div className="text-sm animate-pulse" style={{ animationDelay: '0.2s' }}>🚀</div>
              <div className="text-sm animate-pulse" style={{ animationDelay: '0.4s' }}>⭐</div>
            </div>
          </div>
        </div>
