...
export const QuestSystem: React.FC<QuestSystemProps> = ({ account, onQuestComplete, refreshAccountData }) => {
              ...
              >
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className={`text-sm font-semibold leading-tight ${isCompleted ? 'text-green-300' : 'text-white'}`}>
                        {quest.title}
                      </h3>
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-medium text-blue-400">+{quest.rewards.experience} XP</span>
                    <span className="text-xs font-medium text-purple-400">+{quest.rewards.points} pts</span>
                  </div>
                  {quest.rewards.badgeId && (
                ...
                <div className="space-y-2">
                  {isCompleted ? (
                    ...
                    <div className="space-y-1">
                      ...
                      ) : quest.requirements.target && quest.requirements.target.startsWith('http') ? (
                        <a
                          href={quest.requirements.target}
                          target="_blank"
                          rel="noopener noreferrer"
