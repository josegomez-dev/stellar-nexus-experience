...
import { useDemoCompletionHistory, DemoCompletionRecord } from '@/hooks/useDemoCompletionHistory';
...
export const DemoCompletionHistory: React.FC<DemoCompletionHistoryProps> = ({
  ...
  return (
    <div className={`bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-400/30 rounded-lg p-4 ${className}`}>
      {/* Header */}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
        ...
        <div className="bg-white/5 rounded-lg p-3 border border-white/10">
          ...
          <div className={`text-lg font-semibold ${getScoreColor(averageScore)}`}>{averageScore}%</div>
        </div>
      </div>
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <div className={`px-2 py-1 rounded-full text-xs font-medium ${getScoreBadgeColor(record.score)}`}>
                        {record.score}%
                      </div>
